Current theme is Hachiko, the only modification is that [_background_opacity_](https://sw.kovidgoyal.net/kitty/conf/#opt-kitty.background_opacity) is set to 0
